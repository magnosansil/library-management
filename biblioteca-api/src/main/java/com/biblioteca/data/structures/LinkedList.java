/**
 * Implementação de lista duplamente encadeada com capacidade limitada.
 *
 * <p>Fornece operações básicas de lista: inserir em posição, acrescentar no fim,
 * selecionar, atualizar, remover, limpar e imprimir. A capacidade máxima é
 * estabelecida no construtor. Os índices usados nos métodos seguem a lógica
 * do parâmetro {@code LogicIndex} (0-based).</p>
 *
 * <p>Exceções lançadas:
 * - {@code OverflowException} quando a lista estiver cheia;
 * - {@code UnderflowException} quando a lista estiver vazia;
 * - {@code IndexOutOfBoundsException} para índices inválidos.</p>
 *
 * <p>Observação: não é thread-safe.</p>
 *
